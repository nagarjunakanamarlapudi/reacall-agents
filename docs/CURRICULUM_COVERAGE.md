...
| Failures and recovery | Snapshot fallback, deterministic model-failure injection/fallback, circuit open, durable restart, stale/digest/key rejection, lost-response same-key recovery | Failure selector; R02/R08–R14/R18–R20; no exercised provider-retry claim |
