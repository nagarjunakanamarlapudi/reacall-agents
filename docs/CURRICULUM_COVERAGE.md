...
| Cost, latency, and reliability | Two-hop/four-query/eight-read retrieval budget, one-attempt writes, bounded model calls and one child completion correction; usage only when returned | Latest terminal attempt: 371.975s / 82,420 tokens; timeout → explicit deterministic fallback; successful live E2E metrics unavailable |
