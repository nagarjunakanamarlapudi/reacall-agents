...
Three polished PNGs are the primary presentation visuals:
...
| `03_orchestration` | Shows the exact investigation nodes, deterministic/Deep Agents branches, verifier, and versioned action loop. |
