...
def test_make_ci_dry_run_is_credential_free_and_covers_core_gates() -> None:
    """Break caught: hosted CI is only a badge and omits the executable project gates."""
